...
#define ImageRadius 0.7

@interface TSCTabBarButton()
@property(nonatomic,weak) TSCBadgeView * badgeView;

@end

@implementation TSCTabBarButton
...
// 懒加载badgeView
- (TSCBadgeView *)badgeView{
    
    if (_badgeView == nil) {
        
        TSCBadgeView *btn = [TSCBadgeView buttonWithType:UIButtonTypeCustom];
...
- (void)layoutSubviews{
    ...
    CGFloat imageH = self.bounds.size.height * ImageRadius;
